    ...
    <>
      <Container>
        <a
          ...
          rel="noreferrer"
        >
          <UilGithub size="30" color="#ABADAD" />
        </a>
        <a
          target="_blank"
          href="https://www.linkedin.com/in/mohlutfifauzi/"
          rel="noreferrer"
        >
          <UilLinkedin size="30" color="#ABADAD" />
        </a>
        <a
          target="_blank"
          href="https://instagram.com/mohlutfifauzi"
          rel="noreferrer"
        >
          <UilInstagram size="30" color="#ABADAD" />
        </a>
